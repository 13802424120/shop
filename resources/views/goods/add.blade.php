    ...
    <div class="body-content">
        <form method="post" class="form-x" action="" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <div class="field">
                    <input type="text" class="input w50" name="goods_price" data-validate="required:请输入价格"/>
                    <div class="tips"></div>
                </div>
            </div>
            <div class="form-group">
            ...
            <if condition="$iscid eq 1">
                <div class="form-group">
                    ...
                    <div class="field">
                        <select name="goods_sort" class="input w50"  data-validate="required:请选择分类">
                ...
                <div class="form-group">
                    ...
                    <div class="field" style="padding-top:8px;">
                        上架 <input id="ishome" type="checkbox" name="is_putaway" value="1" checked="checked"/>
                        下架 <input id="isvouch" type="checkbox" name="is_putaway" value="0"/>
                    </div>
                </div>
            </if>
            <div class="form-group">
                ...
                <div class="field">
                    <textarea name="goods_describe" class="input"
